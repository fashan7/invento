...
function getcustomer() {
	...
	if (req) {
		req.onreadystatechange = function() {
			if (req.readyState == 4) {		// data is retrieved from server
				if (req.status == 200) {	// which reprents ok status
					document.getElementById('getcustomerview').innerHTML = req.responseText;
				}
				else {
					alert("Please Wait !!");
				}
		...
		strURL = "getcustomerview.php?cusid="+cusid;
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Customer View</h3>
                        <p class="animated fadeInDown">
                          Reports <span class="fa-angle-right fa"></span> Customer View
                        </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-md-8">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">
                         <h4>Customer View Form</h4>
                        </div>
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-4">       
                            <label>Customer Name</label>
                              <select class="form-control select2-B" name = "cusid" id = "cusid" style="margin-bottom:20px;" onchange="getcustomer();">
                                 <option value = "">All</option>
                                   ...
                                   {                                   
                                   ?>
                                    <option value = "<?php echo $fetchselectcustomer['id'];?>"><?php echo $fetchselectcustomer['name'];?></option>
                                   <?php
                                   }
                                   ?>
                                </select>
