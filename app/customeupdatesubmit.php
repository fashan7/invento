...
$error = false;
    ...
    <div class="row col-lg-12">
			...
			<script type="text/javascript">
				setTimeout("location.href = 'customereditorview.php';",1000);	// Page Dillay 2 Second
			</script>
        <?php
    }
	...
	if(!$error)
	{
		if($customer->updatecustomer($cname, $contactperson, $telenmum, $fax, $address, $customerid))
		{
			?>
			<div class="row col-lg-12">
				<div class="col-lg-3"></div>
				<div class="col-lg-6">
					<div class="alert alert-success">
    					<strong>Alert !   </strong>Customer Updated<br>
  					</div>
				</div>
				<div class="col-lg-3"></div>
			</div>		
