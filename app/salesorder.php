...
function addMore()
{
    ...
    for(i = 2; i <= totalrows; i++)
    {
        ...
        {			
            ...
            tech += '<td data-label="Item Name"><input type="text" class="form-control" required id="itemname' + i + '" onkeyup="autoitem('+ i +')" name="itemname' + i + '"/></td>';        
        ...
        else    
        {
            ...
            tech += '<td data-label="Item Name"><input type="text" class="form-control" required id="itemname' + i + '" onkeyup="autoitem('+ i +')" name="itemname' + i + '" value="'+itemname[i]+'"/></td>';        
...
function deleteAddRows(row)
{
    ...
    for(; i <= int_num_rows; i++)
    {
        ...
        else
        {
            ...
            tech += '<td data-label="Item Name"><input type="text" class="form-control" required id="itemname' + j + '" onkeyup="autoitem('+ j +')" name="itemname' + j + '" value="'+itemname[j]+'"/></td>';        
                             ...
                             <div class = "col-md-12">
                              <div class="col-md-3" style = "margin-bottom:20px;">
                                <label class="control-label text-right">Order No</label>
                                    <input type="text" class="form-control android" name="orderno" id="orderno" value="<?=$salesorderid?>" readonly>
                              </div>                       
                                <div class="col-md-3" style = "margin-bottom:20px;"> 
                                <label >Order Date</label>
                                    <input type="text" class="form-text mask-placeholder form-control android" placeholder="MM/DD/YYYY" name="orderdate" id="orderdate" value="<?=$date?>">
                                </div>
                              </div>
                                <div class = "col-md-12">
                              <div class="col-md-4" style = "margin-bottom:20px;">
                                  <label class="control-label text-right">Customer Name <span id = "redstar">*</span></label>
                                    <input type="text" class="form-control android" required name="customername" id="customername" onkeyup="autoCustomername();" autocomplete="off">
                              </div>                       
                                <div class="col-md-4" style = "margin-bottom:20px;"> 
                                <label>Cust Code <span id = "redstar">*</span></label>
                                    <input type="text" class="form-control android" required name="customercode" id="customercode" onkeyup="autoCustomerCode();" autocomplete="off">
                                    <input type="hidden" name="customerid" id="customerid">
                                </div>
                                <div class="col-md-4" style = "margin-bottom:20px;"> 
                                <label>Phone <span id = "redstar">*</span></label>
                                    <input type="text" class="form-control android" required name="phone" id="phone">
                                </div>                                
                              </div>
                             <div class = "col-md-12">
							  <div class="col-md-6" style = "margin-bottom:20px;"> 
                                <label>Address <span id = "redstar">*</span></label>
                                    <input type="text" class="form-control android" required name="address" id="address">
                               </div> 
                             <div class="col-md-3" style = "margin-bottom:20px;"> 
                                    ...
                                    <tbody>
                                        <tr>
                                            <td data-label="Item Name">
                                                <input type="text" class="form-control" required name="itemname1" id="itemname1" autocomplete="off" onkeyup="autoitem(1)">
                                            </td>
